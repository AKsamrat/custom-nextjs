        ...
        <div className="mt-10 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 pt-10">
          <Slide direction="left" duration={1000}>
            <div className="p-4 border-2 rounded-xl bg-[#ffffff8d] flex justify-start items-center gap-5 hover:scale-105 overflow-hidden  duration-700 ">
              <Image className="w-20 h-20" src={html} alt="html" width={20} height={20} />
          ...
          <Slide direction="right" duration={1000}>
            <div className="p-4 border-2 rounded-xl bg-[#ffffff8d] flex justify-start items-center gap-5 hover:scale-105 overflow-hidden  duration-700">
              <Image className="w-20 h-20" src={css} alt="" width={20} height={20} />
              <div className="w-full">
          ...
          <Slide direction="left" duration={1000}>
            <div className="p-4 border-2 rounded-xl bg-[#ffffff8d] flex justify-start items-center gap-5 hover:scale-105 overflow-hidden  duration-700 ">
              <Image className="w-20 h-20" src={tailwind} alt="" width={20} height={20} />
              <div className="w-full">
          ...
          <Slide direction="right" duration={1000}>
            <div className="p-4 border-2 rounded-xl bg-[#ffffff8d] flex justify-start items-center gap-5 hover:scale-105 overflow-hidden  duration-700">
              <Image className="w-[70px] h-20" src={node} alt="" width={20} height={20} />
              <div className="w-full">
          ...
          <Slide direction="left" duration={1000}>
            <div className="p-4 border-2 rounded-xl bg-[#ffffff8d] flex justify-start items-center gap-5 hover:scale-105 overflow-hidden  duration-700">
              <Image className="w-20 h-20" src={expree} alt="" width={20} height={20} />
              <div className="w-full">
