...
const BlogCard = ({ blog }: { blog: Blog }) => {
  console.log("card data", blog)
  return (
    <div className="w-full bg-white shadow-md rounded-lg overflow-hidden mt-10">
      <figure>
        <Image
          src={`${blog?.image}`}
          width={600}
      ...
      <div className="p-6">
        ...
        <p className="text-gray-400 mt-2">
          {blog.description.length > 100
            ...
            : blog.description}
          <Link href={`/project/${blog._id}`} className="text-teal-600 ml-1">
            Read More
          </Link>
        </p>
